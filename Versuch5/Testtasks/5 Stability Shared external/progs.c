//-------------------------------------------------
//          TestTask: Stability Shared External
//-------------------------------------------------
...
#error "Please lower PROCESS_NUMBER"
#endif
...
void program1(void) {
    ...
    while (1) {
        ...
        if (start != end) {
            ...
            sei();
            const Time now = os_systemTime_coarse(); // Granularity: 0.1/8 ms
